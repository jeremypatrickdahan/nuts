...
function Nuts(opts) {
    ...
    this.router.get(this.opts.prefix + '/', this.onDownload);
    this.router.get(this.opts.prefix + '/download/channel/:channel/:platform?', this.onDownload);
    this.router.get(this.opts.prefix + '/download/version/:tag/:platform?', this.onDownload);
    this.router.get(this.opts.prefix + '/download/:tag/:filename', this.onDownload);
    this.router.get(this.opts.prefix + '/download/:platform?', this.onDownload);

    this.router.get(this.opts.prefix + '/feed/channel/:channel.atom', this.onServeVersionsFeed);

    this.router.get(this.opts.prefix + '/update', this.onUpdateRedirect);
    this.router.get(this.opts.prefix + '/update/:platform/:version', this.onUpdate);
    this.router.get(this.opts.prefix + '/update/channel/:channel/:platform/:version', this.onUpdate);
    this.router.get(this.opts.prefix + '/update/:platform/:version/RELEASES', this.onUpdateWin);
    this.router.get(this.opts.prefix + '/update/channel/:channel/:platform/:version/RELEASES', this.onUpdateWin);

    this.router.get(this.opts.prefix + '/notes/:version?', this.onServeNotes);

    // Bind API
    this.router.use('/api', this.onAPIAccessControl);
    _.each(API_METHODS, function(method, route) {
        this.router.get(this.opts.prefix + '/api/' + route, function(req, res, next) {
            return Q()
            .then(function() {
